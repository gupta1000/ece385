...
module lab8_soc_mm_interconnect_0 (
		...
		input  wire        tetris_avl_core_0_RESET_reset_bridge_in_reset_reset, // tetris_avl_core_0_RESET_reset_bridge_in_reset.reset
		...
		output wire [4:0]  tetris_avl_core_0_TETRIS_Slave_address,              //                tetris_avl_core_0_TETRIS_Slave.address
		output wire        tetris_avl_core_0_TETRIS_Slave_write,                //                                              .write
		output wire        tetris_avl_core_0_TETRIS_Slave_read,                 //                                              .read
		input  wire [31:0] tetris_avl_core_0_TETRIS_Slave_readdata,             //                                              .readdata
		output wire [31:0] tetris_avl_core_0_TETRIS_Slave_writedata,            //                                              .writedata
		output wire [3:0]  tetris_avl_core_0_TETRIS_Slave_byteenable,           //                                              .byteenable
		output wire        tetris_avl_core_0_TETRIS_Slave_chipselect            //                                              .chipselect
	);
	...
	wire   [31:0] tetris_avl_core_0_tetris_slave_agent_m0_readdata;                                   // tetris_avl_core_0_TETRIS_Slave_translator:uav_readdata -> tetris_avl_core_0_TETRIS_Slave_agent:m0_readdata
	wire          tetris_avl_core_0_tetris_slave_agent_m0_waitrequest;                                // tetris_avl_core_0_TETRIS_Slave_translator:uav_waitrequest -> tetris_avl_core_0_TETRIS_Slave_agent:m0_waitrequest
	wire          tetris_avl_core_0_tetris_slave_agent_m0_debugaccess;                                // tetris_avl_core_0_TETRIS_Slave_agent:m0_debugaccess -> tetris_avl_core_0_TETRIS_Slave_translator:uav_debugaccess
	wire   [28:0] tetris_avl_core_0_tetris_slave_agent_m0_address;                                    // tetris_avl_core_0_TETRIS_Slave_agent:m0_address -> tetris_avl_core_0_TETRIS_Slave_translator:uav_address
	wire    [3:0] tetris_avl_core_0_tetris_slave_agent_m0_byteenable;                                 // tetris_avl_core_0_TETRIS_Slave_agent:m0_byteenable -> tetris_avl_core_0_TETRIS_Slave_translator:uav_byteenable
	wire          tetris_avl_core_0_tetris_slave_agent_m0_read;                                       // tetris_avl_core_0_TETRIS_Slave_agent:m0_read -> tetris_avl_core_0_TETRIS_Slave_translator:uav_read
	wire          tetris_avl_core_0_tetris_slave_agent_m0_readdatavalid;                              // tetris_avl_core_0_TETRIS_Slave_translator:uav_readdatavalid -> tetris_avl_core_0_TETRIS_Slave_agent:m0_readdatavalid
	wire          tetris_avl_core_0_tetris_slave_agent_m0_lock;                                       // tetris_avl_core_0_TETRIS_Slave_agent:m0_lock -> tetris_avl_core_0_TETRIS_Slave_translator:uav_lock
	wire   [31:0] tetris_avl_core_0_tetris_slave_agent_m0_writedata;                                  // tetris_avl_core_0_TETRIS_Slave_agent:m0_writedata -> tetris_avl_core_0_TETRIS_Slave_translator:uav_writedata
	wire          tetris_avl_core_0_tetris_slave_agent_m0_write;                                      // tetris_avl_core_0_TETRIS_Slave_agent:m0_write -> tetris_avl_core_0_TETRIS_Slave_translator:uav_write
	wire    [2:0] tetris_avl_core_0_tetris_slave_agent_m0_burstcount;                                 // tetris_avl_core_0_TETRIS_Slave_agent:m0_burstcount -> tetris_avl_core_0_TETRIS_Slave_translator:uav_burstcount
	wire          tetris_avl_core_0_tetris_slave_agent_rf_source_valid;                               // tetris_avl_core_0_TETRIS_Slave_agent:rf_source_valid -> tetris_avl_core_0_TETRIS_Slave_agent_rsp_fifo:in_valid
	wire  [107:0] tetris_avl_core_0_tetris_slave_agent_rf_source_data;                                // tetris_avl_core_0_TETRIS_Slave_agent:rf_source_data -> tetris_avl_core_0_TETRIS_Slave_agent_rsp_fifo:in_data
	wire          tetris_avl_core_0_tetris_slave_agent_rf_source_ready;                               // tetris_avl_core_0_TETRIS_Slave_agent_rsp_fifo:in_ready -> tetris_avl_core_0_TETRIS_Slave_agent:rf_source_ready
	wire          tetris_avl_core_0_tetris_slave_agent_rf_source_startofpacket;                       // tetris_avl_core_0_TETRIS_Slave_agent:rf_source_startofpacket -> tetris_avl_core_0_TETRIS_Slave_agent_rsp_fifo:in_startofpacket
	wire          tetris_avl_core_0_tetris_slave_agent_rf_source_endofpacket;                         // tetris_avl_core_0_TETRIS_Slave_agent:rf_source_endofpacket -> tetris_avl_core_0_TETRIS_Slave_agent_rsp_fifo:in_endofpacket
	wire          tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_valid;                            // tetris_avl_core_0_TETRIS_Slave_agent_rsp_fifo:out_valid -> tetris_avl_core_0_TETRIS_Slave_agent:rf_sink_valid
	wire  [107:0] tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_data;                             // tetris_avl_core_0_TETRIS_Slave_agent_rsp_fifo:out_data -> tetris_avl_core_0_TETRIS_Slave_agent:rf_sink_data
	wire          tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_ready;                            // tetris_avl_core_0_TETRIS_Slave_agent:rf_sink_ready -> tetris_avl_core_0_TETRIS_Slave_agent_rsp_fifo:out_ready
	wire          tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_startofpacket;                    // tetris_avl_core_0_TETRIS_Slave_agent_rsp_fifo:out_startofpacket -> tetris_avl_core_0_TETRIS_Slave_agent:rf_sink_startofpacket
	wire          tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_endofpacket;                      // tetris_avl_core_0_TETRIS_Slave_agent_rsp_fifo:out_endofpacket -> tetris_avl_core_0_TETRIS_Slave_agent:rf_sink_endofpacket
	wire          cmd_mux_src_valid;                                                                  // cmd_mux:src_valid -> tetris_avl_core_0_TETRIS_Slave_agent:cp_valid
	wire  [106:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> tetris_avl_core_0_TETRIS_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // tetris_avl_core_0_TETRIS_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [13:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> tetris_avl_core_0_TETRIS_Slave_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                          // cmd_mux:src_startofpacket -> tetris_avl_core_0_TETRIS_Slave_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                            // cmd_mux:src_endofpacket -> tetris_avl_core_0_TETRIS_Slave_agent:cp_endofpacket
	...
	wire          tetris_avl_core_0_tetris_slave_agent_rp_valid;                                      // tetris_avl_core_0_TETRIS_Slave_agent:rp_valid -> router_002:sink_valid
	wire  [106:0] tetris_avl_core_0_tetris_slave_agent_rp_data;                                       // tetris_avl_core_0_TETRIS_Slave_agent:rp_data -> router_002:sink_data
	wire          tetris_avl_core_0_tetris_slave_agent_rp_ready;                                      // router_002:sink_ready -> tetris_avl_core_0_TETRIS_Slave_agent:rp_ready
	wire          tetris_avl_core_0_tetris_slave_agent_rp_startofpacket;                              // tetris_avl_core_0_TETRIS_Slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          tetris_avl_core_0_tetris_slave_agent_rp_endofpacket;                                // tetris_avl_core_0_TETRIS_Slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          tetris_avl_core_0_tetris_slave_agent_rdata_fifo_src_valid;                          // tetris_avl_core_0_TETRIS_Slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] tetris_avl_core_0_tetris_slave_agent_rdata_fifo_src_data;                           // tetris_avl_core_0_TETRIS_Slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          tetris_avl_core_0_tetris_slave_agent_rdata_fifo_src_ready;                          // avalon_st_adapter:in_0_ready -> tetris_avl_core_0_TETRIS_Slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                                      // avalon_st_adapter:out_0_valid -> tetris_avl_core_0_TETRIS_Slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                                       // avalon_st_adapter:out_0_data -> tetris_avl_core_0_TETRIS_Slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                      // tetris_avl_core_0_TETRIS_Slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                      // avalon_st_adapter:out_0_error -> tetris_avl_core_0_TETRIS_Slave_agent:rdata_fifo_sink_error
	...
	) tetris_avl_core_0_tetris_slave_translator (
		.clk                    (clk_0_clk_clk),                                         //                      clk.clk
		.reset                  (tetris_avl_core_0_RESET_reset_bridge_in_reset_reset),   //                    reset.reset
		.uav_address            (tetris_avl_core_0_tetris_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (tetris_avl_core_0_tetris_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (tetris_avl_core_0_tetris_slave_agent_m0_read),          //                         .read
		.uav_write              (tetris_avl_core_0_tetris_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (tetris_avl_core_0_tetris_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (tetris_avl_core_0_tetris_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (tetris_avl_core_0_tetris_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (tetris_avl_core_0_tetris_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (tetris_avl_core_0_tetris_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (tetris_avl_core_0_tetris_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (tetris_avl_core_0_tetris_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (tetris_avl_core_0_TETRIS_Slave_address),                //      avalon_anti_slave_0.address
		.av_write               (tetris_avl_core_0_TETRIS_Slave_write),                  //                         .write
		.av_read                (tetris_avl_core_0_TETRIS_Slave_read),                   //                         .read
		.av_readdata            (tetris_avl_core_0_TETRIS_Slave_readdata),               //                         .readdata
		.av_writedata           (tetris_avl_core_0_TETRIS_Slave_writedata),              //                         .writedata
		.av_byteenable          (tetris_avl_core_0_TETRIS_Slave_byteenable),             //                         .byteenable
		.av_chipselect          (tetris_avl_core_0_TETRIS_Slave_chipselect),             //                         .chipselect
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) tetris_avl_core_0_tetris_slave_agent (
		.clk                     (clk_0_clk_clk),                                                   //             clk.clk
		.reset                   (tetris_avl_core_0_RESET_reset_bridge_in_reset_reset),             //       clk_reset.reset
		.m0_address              (tetris_avl_core_0_tetris_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (tetris_avl_core_0_tetris_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (tetris_avl_core_0_tetris_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (tetris_avl_core_0_tetris_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (tetris_avl_core_0_tetris_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (tetris_avl_core_0_tetris_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (tetris_avl_core_0_tetris_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (tetris_avl_core_0_tetris_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (tetris_avl_core_0_tetris_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (tetris_avl_core_0_tetris_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (tetris_avl_core_0_tetris_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (tetris_avl_core_0_tetris_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (tetris_avl_core_0_tetris_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (tetris_avl_core_0_tetris_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (tetris_avl_core_0_tetris_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (tetris_avl_core_0_tetris_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (tetris_avl_core_0_tetris_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (tetris_avl_core_0_tetris_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (tetris_avl_core_0_tetris_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (tetris_avl_core_0_tetris_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (tetris_avl_core_0_tetris_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                                   //                .error
		.rdata_fifo_src_ready    (tetris_avl_core_0_tetris_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (tetris_avl_core_0_tetris_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (tetris_avl_core_0_tetris_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) tetris_avl_core_0_tetris_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                   //       clk.clk
		.reset             (tetris_avl_core_0_RESET_reset_bridge_in_reset_reset),             // clk_reset.reset
		.in_data           (tetris_avl_core_0_tetris_slave_agent_rf_source_data),             //        in.data
		.in_valid          (tetris_avl_core_0_tetris_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (tetris_avl_core_0_tetris_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (tetris_avl_core_0_tetris_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (tetris_avl_core_0_tetris_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (tetris_avl_core_0_tetris_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	lab8_soc_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (tetris_avl_core_0_tetris_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (tetris_avl_core_0_tetris_slave_agent_rp_valid),         //          .valid
		.sink_data          (tetris_avl_core_0_tetris_slave_agent_rp_data),          //          .data
		.sink_startofpacket (tetris_avl_core_0_tetris_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (tetris_avl_core_0_tetris_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                         //       clk.clk
		.reset              (tetris_avl_core_0_RESET_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (tetris_avl_core_0_RESET_reset_bridge_in_reset_reset),       // in_rst_0.reset
		.in_0_data      (tetris_avl_core_0_tetris_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (tetris_avl_core_0_tetris_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (tetris_avl_core_0_tetris_slave_agent_rdata_fifo_src_ready), //         .ready
